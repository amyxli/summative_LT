...
welcome.ethics.recompense = 'You will receive ' + welcome.task.pay + ' if you are an online participant taking part via Amazon Mechanical Turk, as recompense for your participation. You may also earn a bonus of up to $1.70 USD, depending on your performance on the task.';
...
'		<br><br>' +
'			<!-- Age -->' +
'           <label for="age"><b>*Age: &nbsp;</b></label><input type = "number" min="18" max="100000" id="age" name="age" /><br /><br />' +
'			<!-- Country -->' +
